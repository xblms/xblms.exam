...
var methods = {
  ...
  msgNoticeShadowLoading: function (noticeContent) {
    this.layerMsgId = layer.msg('<div class="px-5 py-3 text-center text-light"><i class="el-icon-loading fs-1"></i><div class="mt-3">' + noticeContent + '</div></div>', { time: 0, shade: 0.3 }, function () { });
  },
  msgError: function (err) {
    layer.msg('<div class="p-5 text-center text-light"><i class="el-icon-error fs-1"></i><div class="mt-3">' + err + '</div></div>');
  },
