...
namespace XBLMS.Web.Controllers.Admin.Common
{
    ...
    {
        [HttpGet, Route(RouteExam)]
        public async Task<ActionResult<GetExamResult>> GetExam([FromQuery] GetRequest request)
        {
            var (total, list) = await _databaseManager.ExamPaperStartRepository.Analysis_GetListAsync(request.Id, false, request.DateFrom, request.DateTo, request.PageIndex, request.PageSize);
